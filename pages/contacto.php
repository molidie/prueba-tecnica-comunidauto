    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200">
                ...
                <a href="/pages/ayuda.php" class="text-sm font-semibold text-primary hover:text-primary-dark flex items-center gap-1">
                    Ir al centro de ayuda <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
